...
export const WalletIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M19 7V4a1 1 0 0 0-1-1H5a2 2 0 0 0 0 4h15a1 1 0 0 1 1 1v4h-3a2 2 0 0 0 0 4h3v1a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h14" /><path d="M21 12h-3" /></svg>
);
...
export const PiggyBankIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M10 20.5c.7-.2 1.2-.8 1.5-1.5.3-.7.3-1.5 0-2.2-.3-.7-.8-1.2-1.5-1.5-.7-.3-1.5-.3-2.2 0-.7.3-1.2.8-1.5 1.5-.3.7-.3 1.5 0 2.2.3.7.8 1.2 1.5 1.5.7.3 1.5.3 2.2 0Z"/><path d="M16.5 9.4c.3-.7.3-1.5 0-2.2-.3-.7-.8-1.2-1.5-1.5-.7-.3-1.5-.3-2.2 0-.7.3-1.2.8-1.5 1.5-.3.7-.3-1.5 0 2.2.3.7.8 1.2 1.5 1.5.7.3 1.5.3 2.2 0Z"/><path d="M18 10c0-1.1-.9-2-2-2h-1a3 3 0 0 0-3 3v1c0 1.7 1.3 3 3 3h1c1.1 0 2-.9 2-2Z"/><path d="m21.5 12.5-1.9-1.9C18.4 9.4 17.3 9 16 9h-1.5c-1.2 0-2.3.7-2.8 1.8L10 14.5"/><path d="M4.5 11.5c-2 2.2-2.8 5.4-1.5 7.8s4.1 3.5 6.7 3.2c2.6-.3 4.8-2.1 5.6-4.5"/><path d="m9.3 11.7 2.8-2.8c.3-.3.7-.4 1.1-.4h4.3c1.1 0 2.1-1 2.1-2.1 0-1.2-1-2.2-2.1-2.2H10.9c-.4 0-.8.2-1.1.4L7 7"/></svg>
);
...
export const FilePlusIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/><path d="M9 15h6"/><path d="M12 12v6"/></svg>
);
